...
!(function(n, t) {
  ...
  function A(t, i, n, r, e, u, o, l, s) {
      ...
      (i.n = S(i.n, function(n) {
        if (null != n) {
          if (
            ((n.i = i),
            (n.e = i.e + 1),
            null === (a = g[c]) || (a && n.key == a.key && n.type === a.type))
          )
            g[c] = void 0;
          else
            for (f = 0; f < b; f++) {
          ...
          if (
            ...
            (f = n.ref) && a.ref != f && (p = p || []).push(f, n.c || h, n),
            null != h)
          ) {
    ...
    for (c = b; c--; ) null != g[c] && R(g[c], g[c]);
    if (p) for (c = 0; c < p.length; c++) N(p[c], p[++c], p[++c]);
  }
  function S(n, t, i) {
        ...
        if (
          ...
          null != x.getDerivedStateFromProps &&
            j(
              ...
              x.getDerivedStateFromProps(b, a.j)
            ),
          h)
        )
          null == x.getDerivedStateFromProps &&
          ...
          if (
            ...
            !l &&
              ...
              !1 === a.shouldComponentUpdate(b, a.j, w))
          ) {
            for (
              a.props = b,
                a.state = a.j,
        ...
        for (
          v = a.props,
            ...
            h ||
              ...
              (p = a.getSnapshotBeforeUpdate(v, d)),
            A(n, t, i, r, e, u, o, s, c),
            a.base = t.o;
          (f = a.M.pop());
  ...
  (K.prototype.set = function(n) {
          ...
          e < 66
            ? ((t = 255),
              (i =
                ...
                104.49216199393888 * F(i)),
              e < 20
                ? 0
                : 0.8274096064007395 * (r = e - 10) -
                  254.76935184120902 +
                  115.67994401066147 * F(r))
            : ((t =
                351.97690566805693 +
                0.114206453784165 * (t = e - 55) -
                40.25366309332127 * F(t)),
              (i =
                325.4494125711974 +
                0.07943456536662342 * (i = e - 50) -
                28.0852963507957 * F(i)),
              255)),
        { r: L(t), g: L(i), b: L(r) }
      );
    }),
    ...
    (Q.rgbString.set = function(n) {
      ...
      if (
        ((t = g.exec(n))
          ? ((i = U(t[1], 255)), (r = U(t[2], 255)), (e = U(t[3], 255)))
          : (t = b.exec(n)) &&
            ((i = U(t[1], 255)),
            (r = U(t[2], 255)),
            (e = U(t[3], 255)),
    ...
    (Q.hexString.set = function(n) {
      ...
      if (
        ((t = W.exec(n))
          ? ((i = 17 * q(t[1])), (r = 17 * q(t[2])), (e = 17 * q(t[3])))
          : (t = $.exec(n))
          ? ((i = 17 * q(t[1])),
            (r = 17 * q(t[2])),
            (e = 17 * q(t[3])),
            (u = 17 * q(t[4])))
          : (t = B.exec(n))
          ? ((i = q(t[1])), (r = q(t[2])), (e = q(t[3])))
          : (t = D.exec(n)) &&
            ((i = q(t[1])), (r = q(t[2])), (e = q(t[3])), (u = q(t[4]))),
        !t)
      )
    ...
    (Q.hslString.set = function(n) {
      ...
      if (
        ((t = P.exec(n))
          ? ((i = U(t[1], 360)), (r = U(t[2], 100)), (e = U(t[3], 100)))
          : (t = z.exec(n)) &&
            ((i = U(t[1], 360)),
            (r = U(t[2], 100)),
            (e = U(t[3], 100)),
    ...
    sn = (function(t) {
      ...
      return (
        ...
        (((n.prototype = Object.create(
          t && t.prototype
        )).constructor = n).prototype.render = function(n) {
  ...
  function cn(n) {
    ...
    return d(
      ...
      i && d("use", Object.assign({ xlinkHref: un(i) }, n.props)),
      !i &&
  ...
  var fn = Array.apply(null, { length: 360 }).map(function(n, t) {
    return t;
  });
  function an(e) {
    var n = Y(e),
      ...
      Object.assign({}, e, {
        onInput: function(n, t, i) {
          if (0 === i) {
            ...
            null !== r
              ? f.setActiveColor(r)
              : ((f.inputActive = !0), (a.hsv = nn(e, n, t)), e.onInput(i));
    ...
    var u = e.color,
      ...
      c = (function(n, t) {
        ...
        switch (n.sliderType) {
          ...
          case "saturation":
            var d = K.hsvToHsl({ h: i.h, s: 0, v: i.v }),
              p = K.hsvToHsl({ h: i.h, s: 100, v: i.v });
            return [
              [0, "hsl(" + d.h + "," + d.s + "%," + d.l + "%)"],
              [100, "hsl(" + p.h + "," + p.s + "%," + p.l + "%)"]
            ];
          case "value":
          default:
            var g = K.hsvToHsl({ h: i.h, s: i.s, v: 100 });
            return [
              [0, "#000"],
              [100, "hsl(" + g.h + "," + g.s + "%," + g.l + "%)"]
            ];
  ...
  var vn = (function(i) {
    ...
    return (
      ...
      (((n.prototype = Object.create(
        i && i.prototype
      )).constructor = n).prototype.addColor = function(n, t) {
      ...
      (n.prototype.render = function(n, e) {
        ...
        return (
          Array.isArray(t) ||
            ((t = [{ component: an }, { component: hn }]),
            e.transparency &&
              t.push({ component: hn, options: { sliderType: "alpha" } })),
          d(
            "div",
            {
          ...
          Object.assign({}, e, {
            onInput: function(n, t, i) {
              if (0 === i) {
                ...
                null !== r
                  ? s.setActiveColor(r)
                  : ((s.inputActive = !0), (c.hsv = rn(e, n, t)), e.onInput(i));
